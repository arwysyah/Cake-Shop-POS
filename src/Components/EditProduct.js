...
export default class EditProduct extends React.Component {
  ...
  handleOk = async () => {
    ...
    await axios
      ...
      }).then((swal("Edit Product Successfully!", "Your Product has Edited", "success"))).then(()=>{
  ...
  render() {
    ...
    return (
      <div>
       <p onClick={this.showModal}><a>Editsss</a></p>
        <Modal
          visible={visible}
          title="Edit Product"
          onOk={this.handleOk}
        ...
        <form >
          <img src={this.state.image_url} alt="img"  style={{height:50,width:60}}/>
