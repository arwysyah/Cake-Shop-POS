...
class CheckOut extends React.Component {
  ...
  handleOk = async() => {
    ...
    await Axios.post(`http://localhost:5050/history/`,formData).then(res=>{
      console.log(res,'res')
    }).then((swal("Transaction Succes!", "Thanks fror Using Our Services!", "success")))
          ...
          <div style={{ marginTop: 20 }}>
            <table style={{ width: "100%" }}>
              <tr style={{ fontWeight: "bold" }}>
                <td>PPN 10 % </td>
                <td>:</td>
                <td style ={{marginLeft:140}}>Rp. {this.formatNumber(ppn)}</td>
              </tr>
